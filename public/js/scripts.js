...
window.FontAwesomeKitConfig = { "asyncLoading": { "enabled": true }, "autoA11y": { "enabled": true }, "baseUrl": "https://kit-pro.fontawesome.com", "license": "pro", "method": "js", "minify": { "enabled": true }, "v4shim": { "enabled": true }, "version": "latest" };
...
//Funtion for smooth scroll between links
...
//Call expandNavOnScroll() when scrolled
window.onscroll = function() {expandNavOnScroll()};
...
//expand nav bar when scrolled on desktop view function
function expandNavOnScroll() {
if (window.pageYOffset > navPosition) {
document.getElementById("nav").classList.add('navExpand');
} else {
document.getElementById("nav").classList.remove('navExpand');
}
}

//Toggle dropdown menu on mobile view function
function dropdown(){
