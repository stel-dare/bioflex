...
//      slideCont.insertBefore(firstSlide, slideCont.childNodes[slideCont.childNodes.length-1]);
//      console.log(firstSlide);
//  }

//  function slideLeft(){
//     let lastSlide = document.getElementsByClassName('slide')[document.getElementsByClassName('slide').length-1];
//     let slideCont = document.getElementById('slideshow');
//     slideCont.insertBefore(lastSlide, slideCont.childNodes[0]);
